const showall = document.querySelector('.showall').addEventListener('click', function(click) {
    document.getElementsByClassName('cardContainer').innerHTML = `<div class="card">
